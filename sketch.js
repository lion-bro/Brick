...
function draw(){
    ...
    if(gameState === "end"){
        ...
        textSize(40);
        fill("ForestGreen");
        text("GAME OVER",(displayWidth/2)-50,((displayHeight-100)/2)-20);
        text("Reload the page to try again!",(displayWidth/2)-50,((displayHeight-100)/2)+20);
